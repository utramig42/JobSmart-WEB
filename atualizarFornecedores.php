                    ...
                    <form id="provider" method="POST" action="core/dll/FornecedorControllerUpdate.php">
                            ...
                            <div class="form-row">
                                <div class="col-md-2">
                                    <div class="form-label-group">
                                        <input type="number" id="id" id="id" value="<?php echo $data['id_for'] ?>" name="id" class="form-control" placeholder="Código" readonly>
                                ...
                                <div class="col-md-6">
                                    <div class="form-label-group">
                                        <input required autofocus type="text" id="razao-social" id="razao-social" value="<?php echo $data['raz_soc_for'] ?>" name="razao-social" class="form-control" placeholder="Razão Social" readonly>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-8">
                                    <div class="form-label-group">
                                        <input type="text" id="nome-fantasia" name="nome-fantasia" value="<?php echo $data['nm_for'] ?>" class="form-control" placeholder="Nome Fantasia" required>
                                ...
                                <div class="col-md-1">
                                    <div class="form-label-group">
                                        <input required type="text" id="uf" name="uf" value="<?php echo $data['uf_for'] ?>" class="form-control" placeholder="Estado">
                                ...
                                <div class=" col-md-3">
                                    <div class="form-label-group">
                                        <input type="text" id="cidade" name="cidade" value="<?php echo $data['cid_for'] ?>" class="form-control" placeholder="Cidade" required>
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-4">
                                    <div class="form-label-group">
                                        <input type="text" id="nome-contato" name="nome-contato" value="<?php echo $data['nm_cont_for'] ?>" class="form-control" placeholder="Nome do Contato" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-label-group">
                                        <input type="text" id="fixo" name="fixo" value="<?php echo $data['tel_fix_for'] ?>" class=" form-control" placeholder="Telefone Fixo">
                                ...
                                <div class="col-md-3">
                                    <div class="form-label-group">
                                        <input required type="text" id="celular" name="celular" class="form-control" placeholder="Telefone Celular" value="<?php echo $data['tel_cel_for'] ?>">
                                ...
                                <div class="col-md-2">
                                    <div class="form-label-group">
                                        <input type="date" id="data-cadastro" id="data-cadastro" name="data-cadastro" class="form-control" placeholder="Data do Cadastro" value="<?php echo date('Y-m-d', strtotime($data['dt_cad_for'])); ?>" readonly>
