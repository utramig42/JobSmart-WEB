                    ...
                    <form id="provider" method="POST" action="core/dll/FornecedorControllerUpdate.php">
                        ...
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-8">
                                    <div class="form-label-group">
                                        <input type="text" id="nome-fantasia" name="nome-fantasia" value="<?php echo $data['nm_for'] ?>" class="form-control" placeholder="Nome Fantasia" autofocus="autofocus" required>
